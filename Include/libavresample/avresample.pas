...
type
  PAVAudioResampleContext = ^TAVAudioResampleContext;
  TAVAudioResampleContext = record
...
(** Resampling Filter Types *)
  TAVResampleFilterType = (
    AV_RESAMPLE_FILTER_TYPE_CUBIC,              (**< Cubic *)
    AV_RESAMPLE_FILTER_TYPE_BLACKMAN_NUTTALL,   (**< Blackman Nuttall Windowed Sinc *)
    AV_RESAMPLE_FILTER_TYPE_KAISER              (**< Kaiser Windowed Sinc *)
  );

  TAVResampleDitherMethod = (
 ...
 *)
function avresample_version(): Cardinal;
  cdecl; external LIB_AVRESAMPLE;

(**
 * Return the libavresample build-time configuration.
 * @return  configure string
 *)
function avresample_configuration(): PAnsiChar;
  cdecl; external LIB_AVRESAMPLE;

(**
 * Return the libavresample license.
 *)
function avresample_license(): PAnsiChar;
  cdecl; external LIB_AVRESAMPLE;
 ...
 *)
function avresample_open(avr: PAVAudioResampleContext): integer;
  cdecl; external LIB_AVRESAMPLE;
