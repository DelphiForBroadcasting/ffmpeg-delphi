...
{$ENDIF} (* FF_API_XVMC *)
    ...
    AV_CODEC_ID_BRENDER_PIX= (ord('X') or (ord('I') shl 8) or (ord('P') shl 16) or (ord('B') shl 24)), //MKBETAG('B','P','I','X'),
    AV_CODEC_ID_Y41P       = (ord('P') or (ord('1') shl 8) or (ord('4') shl 16) or (ord('Y') shl 24)), //MKBETAG('Y','4','1','P'),
    AV_CODEC_ID_ESCAPE130  = (ord('0') or (ord('3') shl 8) or (ord('1') shl 16) or (ord('E') shl 24)), //MKBETAG('E','1','3','0'),
    AV_CODEC_ID_EXR        = (ord('R') or (ord('X') shl 8) or (ord('E') shl 16) or (ord('0') shl 24)), //MKBETAG('0','E','X','R'),
    AV_CODEC_ID_AVRP       = (ord('P') or (ord('R') shl 8) or (ord('V') shl 16) or (ord('A') shl 24)),//MKBETAG('A','V','R','P'),

    AV_CODEC_ID_012V       = (ord('V') or (ord('2') shl 8) or (ord('1') shl 16) or (ord('0') shl 24)),//MKBETAG('0','1','2','V'),
    AV_CODEC_ID_G2M        = (ord('M') or (ord('2') shl 8) or (ord('G') shl 16) or (0 shl 24)),//MKBETAG( 0 ,'G','2','M'),
    AV_CODEC_ID_AVUI       = (ord('I') or (ord('U') shl 8) or (ord('V') shl 16) or (ord('A') shl 24)),//MKBETAG('A','V','U','I'),
    AV_CODEC_ID_AYUV       = (ord('V') or (ord('U') shl 8) or (ord('Y') shl 16) or (ord('A') shl 24)),//MKBETAG('A','Y','U','V'),
    AV_CODEC_ID_TARGA_Y216 = (ord('6') or (ord('1') shl 8) or (ord('2') shl 16) or (ord('T') shl 24)),//MKBETAG('T','2','1','6'),
    AV_CODEC_ID_V308       = (ord('8') or (ord('0') shl 8) or (ord('3') shl 16) or (ord('V') shl 24)),//MKBETAG('V','3','0','8'),
    AV_CODEC_ID_V408       = (ord('8') or (ord('0') shl 8) or (ord('4') shl 16) or (ord('V') shl 24)),//MKBETAG('V','4','0','8'),
    AV_CODEC_ID_YUV4       = (ord('4') or (ord('V') shl 8) or (ord('U') shl 16) or (ord('Y') shl 24)),//MKBETAG('Y','U','V','4'),
    AV_CODEC_ID_SANM       = (ord('M') or (ord('N') shl 8) or (ord('A') shl 16) or (ord('S') shl 24)),//MKBETAG('S','A','N','M'),
    AV_CODEC_ID_PAF_VIDEO  = (ord('V') or (ord('F') shl 8) or (ord('A') shl 16) or (ord('P') shl 24)),//MKBETAG('P','A','F','V'),
    AV_CODEC_ID_AVRN       = (ord('n') or (ord('R') shl 8) or (ord('V') shl 16) or (ord('A') shl 24)),//MKBETAG('A','V','R','n'),
    AV_CODEC_ID_CPIA       = (ord('A') or (ord('I') shl 8) or (ord('P') shl 16) or (ord('C') shl 24)),//MKBETAG('C','P','I','A'),
    AV_CODEC_ID_XFACE      = (ord('C') or (ord('A') shl 8) or (ord('F') shl 16) or (ord('X') shl 24)),//MKBETAG('X','F','A','C'),
    AV_CODEC_ID_SGIRLE     = (ord('R') or (ord('I') shl 8) or (ord('G') shl 16) or (ord('S') shl 24)),//MKBETAG('S','G','I','R'),
    AV_CODEC_ID_MVC1       = (ord('1') or (ord('C') shl 8) or (ord('V') shl 16) or (ord('M') shl 24)),//MKBETAG('M','V','C','1'),
    AV_CODEC_ID_MVC2       = (ord('2') or (ord('C') shl 8) or (ord('V') shl 16) or (ord('M') shl 24)),//MKBETAG('M','V','C','2'),
    AV_CODEC_ID_SNOW       = (ord('W') or (ord('O') shl 8) or (ord('N') shl 16) or (ord('S') shl 24)),//MKBETAG('S','N','O','W'),
    AV_CODEC_ID_WEBP       = (ord('P') or (ord('B') shl 8) or (ord('E') shl 16) or (ord('W') shl 24)),//MKBETAG('W','E','B','P'),
    AV_CODEC_ID_SMVJPEG    = (ord('J') or (ord('V') shl 8) or (ord('M') shl 16) or (ord('S') shl 24)),//MKBETAG('S','M','V','J'),
    AV_CODEC_ID_HEVC       = (ord('5') or (ord('6') shl 8) or (ord('2') shl 16) or (ord('H') shl 24)),//MKBETAG('H','2','6','5'),
    AV_CODEC_ID_H265       = AV_CODEC_ID_HEVC,
    AV_CODEC_ID_VP7        = (ord('0') or (ord('7') shl 8) or (ord('P') shl 16) or (ord('V') shl 24)),//MKBETAG('V','P','7','0'),
    AV_CODEC_ID_APNG       = (ord('A') or (ord('P') shl 8) or (ord('N') shl 16) or (ord('G') shl 24)),//MKBETAG('A','P','N','G'),
    ...
    AV_CODEC_ID_PCM_S24LE_PLANAR = (ord('P') or (ord('S') shl 8) or (ord('P') shl 16) or (24 shl 24)),//MKBETAG(24,'P','S','P'),
    AV_CODEC_ID_PCM_S32LE_PLANAR = (ord('P') or (ord('S') shl 8) or (ord('P') shl 16) or (32 shl 24)),//MKBETAG(32,'P','S','P'),
    AV_CODEC_ID_PCM_S16BE_PLANAR = (16 or (ord('P') shl 8) or (ord('S') shl 16) or (ord('P') shl 24)),//MKBETAG('P','S','P',16),
    ...
    AV_CODEC_ID_ADPCM_VIMA      = (ord('A') or (ord('M') shl 8) or (ord('I') shl 16) or (ord('V') shl 24)),//MKBETAG('V','I','M','A'),
{$IF FF_API_VIMA_DECODER}
    AV_CODEC_ID_VIMA            = (ord('A') or (ord('M') shl 8) or (ord('I') shl 16) or (ord('V') shl 24)),//MKBETAG('V','I','M','A'),
{$ENDIF}
    AV_CODEC_ID_ADPCM_AFC       = (ord(' ') or (ord('C') shl 8) or (ord('F') shl 16) or (ord('A') shl 24)),//MKBETAG('A','F','C',' '),
    AV_CODEC_ID_ADPCM_IMA_OKI   = (ord(' ') or (ord('I') shl 8) or (ord('K') shl 16) or (ord('O') shl 24)),//MKBETAG('O','K','I',' '),
    AV_CODEC_ID_ADPCM_DTK       = (ord(' ') or (ord('K') shl 8) or (ord('T') shl 16) or (ord('D') shl 24)),//MKBETAG('D','T','K',' '),
    AV_CODEC_ID_ADPCM_IMA_RAD   = (ord(' ') or (ord('D') shl 8) or (ord('A') shl 16) or (ord('R') shl 24)),//MKBETAG('R','A','D',' '),
    AV_CODEC_ID_ADPCM_G726LE    = (ord('G') or (ord('7') shl 8) or (ord('2') shl 16) or (ord('6') shl 24)),//MKBETAG('6','2','7','G'),
    AV_CODEC_ID_ADPCM_THP_LE    = (ord('T') or (ord('H') shl 8) or (ord('P') shl 16) or (ord('L') shl 24)),//MKBETAG('T','H','P','L'),
...
{$ENDIF}
    ...
    AV_CODEC_ID_ON2AVC,
    AV_CODEC_ID_DSS_SP,
    AV_CODEC_ID_FFWAVESYNTH     = (ord('S') or (ord('W') shl 8) or (ord('F') shl 16) or (ord('F') shl 24)),//MKBETAG('F','F','W','S'),
    AV_CODEC_ID_SONIC           = (ord('C') or (ord('N') shl 8) or (ord('O') shl 16) or (ord('S') shl 24)),//MKBETAG('S','O','N','C'),
    AV_CODEC_ID_SONIC_LS        = (ord('L') or (ord('N') shl 8) or (ord('O') shl 16) or (ord('S') shl 24)),//MKBETAG('S','O','N','L'),
    AV_CODEC_ID_PAF_AUDIO       = (ord('A') or (ord('F') shl 8) or (ord('A') shl 16) or (ord('P') shl 24)),//MKBETAG('P','A','F','A'),
    AV_CODEC_ID_OPUS            = (ord('S') or (ord('U') shl 8) or (ord('P') shl 16) or (ord('O') shl 24)),//MKBETAG('O','P','U','S'),
    AV_CODEC_ID_TAK             = (ord('K') or (ord('a') shl 8) or (ord('B') shl 16) or (ord('t') shl 24)),//MKBETAG('t','B','a','K'),
    AV_CODEC_ID_EVRC            = (ord('c') or (ord('v') shl 8) or (ord('e') shl 16) or (ord('s') shl 24)),//MKBETAG('s','e','v','c'),
    AV_CODEC_ID_SMV             = (ord('v') or (ord('m') shl 8) or (ord('s') shl 16) or (ord('s') shl 24)),//MKBETAG('s','s','m','v'),
    AV_CODEC_ID_DSD_LSBF        = (ord('L') or (ord('D') shl 8) or (ord('S') shl 16) or (ord('D') shl 24)),//MKBETAG('D','S','D','L'),
    AV_CODEC_ID_DSD_MSBF        = (ord('M') or (ord('D') shl 8) or (ord('S') shl 16) or (ord('D') shl 24)),//MKBETAG('D','S','D','M'),
    AV_CODEC_ID_DSD_LSBF_PLANAR = (ord('1') or (ord('D') shl 8) or (ord('S') shl 16) or (ord('D') shl 24)),//MKBETAG('D','S','D','1'),
    AV_CODEC_ID_DSD_MSBF_PLANAR = (ord('8') or (ord('D') shl 8) or (ord('S') shl 16) or (ord('D') shl 24)),//MKBETAG('D','S','D','8'),
    AV_CODEC_ID_4GV             = (ord('s') or (ord('4') shl 8) or (ord('g') shl 16) or (ord('v') shl 24)),//MKBETAG('s','4','g','v'),
    ...
    AV_CODEC_ID_SRT,
    AV_CODEC_ID_MICRODVD   = (ord('D') or (ord('V') shl 8) or (ord('D') shl 16) or (ord('m') shl 24)),//MKBETAG('m','D','V','D'),
    AV_CODEC_ID_EIA_608    = (ord('8') or (ord('0') shl 8) or (ord('6') shl 16) or (ord('c') shl 24)),//MKBETAG('c','6','0','8'),
    AV_CODEC_ID_JACOSUB    = (ord('B') or (ord('U') shl 8) or (ord('S') shl 16) or (ord('J') shl 24)),//MKBETAG('J','S','U','B'),
    AV_CODEC_ID_SAMI       = (ord('I') or (ord('M') shl 8) or (ord('A') shl 16) or (ord('S') shl 24)),//MKBETAG('S','A','M','I'),
    AV_CODEC_ID_REALTEXT   = (ord('T') or (ord('X') shl 8) or (ord('T') shl 16) or (ord('R') shl 24)),//MKBETAG('R','T','X','T'),
    AV_CODEC_ID_STL        = (ord('S') or (ord('p') shl 8) or (ord('T') shl 16) or (ord('L') shl 24)),//MKBETAG('S','p','T','L'),
    AV_CODEC_ID_SUBVIEWER1 = (ord('1') or (ord('V') shl 8) or (ord('b') shl 16) or (ord('S') shl 24)),//MKBETAG('S','b','V','1'),
    AV_CODEC_ID_SUBVIEWER  = (ord('V') or (ord('b') shl 8) or (ord('u') shl 16) or (ord('S') shl 24)),//MKBETAG('S','u','b','V'),
    AV_CODEC_ID_SUBRIP     = (ord('p') or (ord('i') shl 8) or (ord('R') shl 16) or (ord('S') shl 24)),//MKBETAG('S','R','i','p'),
    AV_CODEC_ID_WEBVTT     = (ord('T') or (ord('T') shl 8) or (ord('V') shl 16) or (ord('W') shl 24)),//MKBETAG('W','V','T','T'),
    AV_CODEC_ID_MPL2       = (ord('2') or (ord('L') shl 8) or (ord('P') shl 16) or (ord('M') shl 24)),//MKBETAG('M','P','L','2'),
    AV_CODEC_ID_VPLAYER    = (ord('r') or (ord('l') shl 8) or (ord('P') shl 16) or (ord('V') shl 24)),//MKBETAG('V','P','l','r'),
    AV_CODEC_ID_PJS        = (ord('S') or (ord('J') shl 8) or (ord('h') shl 16) or (ord('P') shl 24)),//MKBETAG('P','h','J','S'),
    AV_CODEC_ID_ASS        = (ord(' ') or (ord('S') shl 8) or (ord('S') shl 16) or (ord('A') shl 24)),//MKBETAG('A','S','S',' '),  ///< ASS as defined in Matroska
    AV_CODEC_ID_HDMV_TEXT_SUBTITLE = (ord('B') or (ord('D') shl 8) or (ord('T') shl 16) or (ord('X') shl 24)),//MKBETAG('B','D','T','X'),

    (* other specific kind of codecs (generally used for attachments) *)
    AV_CODEC_ID_FIRST_UNKNOWN = $18000,           ///< A dummy ID pointing at the start of various fake codecs.
    AV_CODEC_ID_TTF = $18000,
    AV_CODEC_ID_BINTEXT    = (ord('T') or (ord('X') shl 8) or (ord('T') shl 16) or (ord('B') shl 24)),//MKBETAG('B','T','X','T'),
    AV_CODEC_ID_XBIN       = (ord('N') or (ord('I') shl 8) or (ord('B') shl 16) or (ord('X') shl 24)),//MKBETAG('X','B','I','N'),
    AV_CODEC_ID_IDF        = (ord('F') or (ord('D') shl 8) or (ord('I') shl 16) or (       0 shl 24)),//MKBETAG( 0 ,'I','D','F'),
    AV_CODEC_ID_OTF        = (ord('F') or (ord('T') shl 8) or (ord('O') shl 16) or (       0 shl 24)),//MKBETAG( 0 ,'O','T','F'),
    AV_CODEC_ID_SMPTE_KLV  = (ord('A') or (ord('V') shl 8) or (ord('L') shl 16) or (ord('K') shl 24)),//MKBETAG('K','L','V','A'),
    AV_CODEC_ID_DVD_NAV    = (ord('V') or (ord('A') shl 8) or (ord('N') shl 16) or (ord('D') shl 24)),//MKBETAG('D','N','A','V'),
    AV_CODEC_ID_TIMED_ID3  = (ord('3') or (ord('D') shl 8) or (ord('I') shl 16) or (ord('T') shl 24)),//MKBETAG('T','I','D','3'),
    AV_CODEC_ID_BIN_DATA   = (ord('A') or (ord('T') shl 8) or (ord('A') shl 16) or (ord('D') shl 24)),//MKBETAG('D','A','T','A'),
...
{$ENDIF}
  ...
  CODEC_FLAG_PASS1           = AV_CODEC_FLAG_PASS1;   ///< Use internal 2pass ratecontrol in first pass mode.
  CODEC_FLAG_PASS2           = AV_CODEC_FLAG_PASS2;   ///< Use internal 2pass ratecontrol in second pass mode.
  CODEC_FLAG_GRAY            = AV_CODEC_FLAG_GRAY;   ///< Only decode/encode grayscale.
...
{$ENDIF}
  CODEC_FLAG_PSNR            = AV_CODEC_FLAG_PSNR;   ///< error[?] variables will be set during encoding.
  CODEC_FLAG_TRUNCATED       = AV_CODEC_FLAG_TRUNCATED; (** Input bitstream might be truncated at a random
 ...
 *)
  ...
  AV_EF_IGNORE_ERR = (1 shl 5);        ///< ignore errors and continue
  ...
  AV_EF_AGGRESSIVE = (1 shl 8);        ///< consider things that a sane encoder should not do as an error
...
(* Const from libavutil/frame.pas *)
const
  (**
...
type
  ...
  TExecute2Func = function(c2: PAVCodecContext; arg: Pointer; jobnr: integer; threadnr: integer): integer; cdecl;
...
{$ENDIF}
    ...
    draw_horiz_band: procedure (s: PAVCodecContext;
                                src: PAVFrame; offset: PAVNDPArray;
...
{$IF FF_API_REQUEST_CHANNELS}
     ...
     *)
    request_channels: integer; {deprecated}
{$ENDIF}
...
{$IF FF_API_GET_BUFFER}
     ...
     *
     * if AV_CODEC_CAP_DR1 is not set then get_buffer() must call
     ...
     *)
    get_buffer: function (c: PAVCodecContext; pic: PAVFrame): integer; cdecl; {deprecated;}
     ...
     * if AV_CODEC_CAP_DR1 is not set then reget_buffer() must call
...
{$ENDIF}
     ...
     *
     *   FF_THREAD_FRAME    ///< Decode more than one frame at once
     *   FF_THREAD_SLICE    ///< Decode more than one part of a single frame at once
     *)
    thread_type: integer;
     ...
     * - decoding: Set by libavcodec, user can override.
     *)
    execute: function (c: PAVCodecContext; func: TExecuteFunc; arg: Pointer; ret: PInteger; count: integer; size: integer): integer; cdecl;
     ...
     * - decoding: Set by libavcodec, user can override.
     *)
      execute2: function (c: PAVCodecContext; func: TExecute2Func; arg2: Pointer; ret: PInteger; count: integer): integer; cdecl;
 ...
 *)
  TAVCodec = record
    ...
    sample_fmts: PPAVSampleFormat; ///< array of supported sample formats, or NULL if unknown, array is terminated by -1
     ...
     *)
    init_thread_copy: function (avctx: PAVCodecContext): Integer; cdecl;
    (**
     ...
     *)
    update_thread_context: function (dst: PAVCodecContext; src: PAVCodecContext): integer; cdecl;
    (** @} *)
    ...
    encode_sub: function (avctx: PAVCodecContext; buf: PByte; buf_size: integer; sub: PAVSubtitle): integer; cdecl;
    (**
     ...
     *)
    encode2: function (avctx: PAVCodecContext; avpkt: PAVPacket; frame: PAVFrame; got_packet_ptr: PInteger): integer; cdecl;
    decode: function (avctx: PAVCodecContext; outdata: pointer; var outdata_size: integer; avpkt: PAVPacket): integer; cdecl;
 ...
 *)
  TAVHWAccel = record
     ...
     *)
     start_frame : function (avctx: PAVCodecContext; buf: PByte; buf_size: cardinal): integer; cdecl;
     ...
     * @return zero if successful, a negative value otherwise
     *)
     decode_slice: function (avctx: PAVCodecContext; buf: PByte; buf_size: cardinal): integer; cdecl;
 ...
 *)
  ...
  function av_codec_get_pkt_timebase(avctx: PAVCodecContext): TAVRational;
    cdecl; external LIB_AVCODEC;
  procedure av_codec_set_pkt_timebase(avctx: PAVCodecContext; val: TAVRational);
    cdecl; external LIB_AVCODEC;

  function av_codec_get_codec_descriptor(avctx: PAVCodecContext): PAVCodecDescriptor;
    cdecl; external LIB_AVCODEC;
  procedure av_codec_set_codec_descriptor(avctx:PAVCodecContext; desc: PAVCodecDescriptor);
    cdecl; external LIB_AVCODEC;

  function av_codec_get_codec_properties(avctx:PAVCodecContext): cardinal;
    cdecl; external LIB_AVCODEC;

  function av_codec_get_lowres(avctx: PAVCodecContext): integer;
    cdecl; external LIB_AVCODEC;
  procedure av_codec_set_lowres(avctx: PAVCodecContext; val: integer);
    cdecl; external LIB_AVCODEC;

  function av_codec_get_chroma_intra_matrix(avctx: PAVCodecContext): PWord;
    cdecl; external LIB_AVCODEC;
...
function av_codec_get_max_lowres(codec : PAVCodec): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function avcodec_get_context_defaults3(s: PAVCodecContext; codec: PAVCodec): integer;
    cdecl; external LIB_AVCODEC;
 ...
 * @see av_opt_find().
 *)
function avcodec_get_class(): PAVClass;
    cdecl; external LIB_AVCODEC;
 ...
 *)
procedure avcodec_free_frame(var frame: PAVFrame);
    cdecl; external LIB_AVCODEC;
{$ENDIF}
 ...
 * @param size new size
 *)
procedure av_shrink_packet(pkt : PAVPacket; size: integer);
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_grow_packet(pkt: PAVPacket; grow_by: integer) : integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_packet_from_data(pkt: PAVPacket; data: PByte; size: integer): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_copy_packet(var dst : PAVPacket; src: PAVPacket): integer;
    cdecl; external LIB_AVCODEC;
 ...
 * @return 0 on success, negative AVERROR on fail
 *)
function av_copy_packet_side_data(var dst : PAVPacket; src: PAVPacket): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_packet_pack_dictionary(dict: PAVDictionary; size: integer): PByte;
    cdecl; external LIB_AVCODEC;
 ...
 * @return 0 on success, < 0 on failure
 *)
function av_packet_unpack_dictionary(const data: PByte; size: integer; dict: PPAVDictionary): integer;
    cdecl; external LIB_AVCODEC;
 ...
 * @return 0 on success, a negative AVERROR on error.
 *)
function av_packet_ref(var dst: PAVPacket; src: PAVPacket): integer;
    cdecl; external LIB_AVCODEC;
 ...
 * @param dst Destination packet
 *)
procedure av_packet_move_ref(var dst: PAVPacket; src: PAVPacket);
    cdecl; external LIB_AVCODEC;
 ...
 *
 *)
function av_packet_copy_props(var dst: PAVPacket; src: PAVPacket): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *               converted
 *)
procedure av_packet_rescale_ts(pkt: PAVPacket; tb_src: TAVRational; tb_dst: TAVRational);
    cdecl; external LIB_AVCODEC;
 ...
 *)
function avcodec_default_get_buffer2(s: PAVCodecContext; frame : PAVFrame; flags: integer): integer;
    cdecl; external LIB_AVCODEC;
...
function avcodec_get_edge_width(): longword;
    cdecl; external LIB_AVCODEC;
{$ENDIF}
 ...
 *)
procedure avcodec_align_dimensions(s : PAVCodecContext; width: integer; height: integer);
    cdecl; external LIB_AVCODEC;
...
type
  TAV_NUM_DATA_POINTERS_ARRAY =  array[0..AV_NUM_DATA_POINTERS-1] of integer;

procedure avcodec_align_dimensions2(s : PAVCodecContext; width: integer; height: integer;
                               linesize_align: TAV_NUM_DATA_POINTERS_ARRAY);
cdecl; external LIB_AVCODEC;
 ...
 *)
function avcodec_enum_to_chroma_pos(xpos : integer; ypos : integer; pos : TAVChromaLocation): integer;
    cdecl; external LIB_AVCODEC;
 ...
 * @param ypos  vertical   chroma sample position
 *)
function avcodec_chroma_pos_to_enum(xpos : integer; ypos : integer): TAVChromaLocation;
    cdecl; external LIB_AVCODEC;
...
function avcodec_decode_audio4(avctx : PAVCodecContext; frame : PAVFrame;
                          var got_frame_ptr : Integer; avpkt :PAVPacket): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
  ...
  TAVCodecParser = record
    ...
    parser_parse: function(s: PAVCodecParserContext;
                           ...
                           buf: PByte; buf_size: integer): integer; cdecl;
    parser_close: procedure(s: PAVCodecParserContext); cdecl;
    split: function(avctx: PAVCodecContext; buf:  PByte; buf_size: integer): integer; cdecl;
    next: PAVCodecParser;
  end;
...
function av_parser_parse2(s: PAVCodecParserContext;
                     avctx: PAVCodecContext;
                     var poutbuf: PByte; var poutbuf_size: integer;
 ...
 *)
function avcodec_encode_audio(avctx: PAVCodecContext;
                              buf: PByte; buf_size: integer;
                              samples: PSmallInt	): integer;
...
function avcodec_encode_audio2(avctx: PAVCodecContext; avpkt: PAVPacket;
                          frame: PAVFrame; var got_packet_ptr: integer): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_audio_resample_init(output_channels: integer; input_channels: integer;
                                        output_rate: integer; input_rate: integer;
                                        sample_fmt_out: TAVSampleFormat;
                                        sample_fmt_in: TAVSampleFormat;
                                        filter_length: integer; log2_phase_count: integer;
                                        linear: integer; cutoff: double): PReSampleContext;
    cdecl; external LIB_AVCODEC; deprecated;

function audio_resample(s: PReSampleContext; var output: PSmallInt; input: PSmallInt; nb_samples: integer): integer;
    cdecl; external LIB_AVCODEC; deprecated;
 ...
 * @param cutoff cutoff frequency, 1.0 corresponds to half the output sampling rate
 *)
function av_resample_init(out_rate: integer; in_rate: integer; filter_length: integer; log2_phase_count: integer; linear: integer; cutoff: double): PAVResampleContext;
    cdecl; external LIB_AVCODEC; deprecated;
 ...
 *)
function av_resample(c: PAVResampleContext; var dst: PSmallInt; src: PSmallInt; consumed: PInteger; src_size: integer; dst_size: integer; update_ctx: integer): integer;
    cdecl; external LIB_AVCODEC; deprecated;
 ...
 *)
procedure av_resample_compensate(c: PAVResampleContext; sample_delta: integer; compensation_distance: integer);
    cdecl; external LIB_AVCODEC; deprecated;
 ...
 *)
function avpicture_alloc(picture: PAVPicture; pix_fmt: TAVPixelFormat; width: integer; height: integer): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function avpicture_layout(src: PAVPicture; pix_fmt: TAVPixelFormat;
                     width: integer; height: integer;
                     dest: PByte; dest_size: integer): integer;
    cdecl; external LIB_AVCODEC;
...
function avpicture_deinterlace(var dst: PAVPicture; src: PAVPicture;
                          pix_fmt: TAVPixelFormat; width: integer; height: integer): integer;
    cdecl; external LIB_AVCODEC; deprecated;
{$ENDIF}
(**
 ...
 *)
procedure av_picture_copy(var dst: PAVPicture; src: PAVPicture;
 ...
 *)
function av_picture_crop(var dst: PAVPicture; src: PAVPicture;
                    pix_fmt : TAVPixelFormat; top_band: integer; left_band: integer): integer;
    cdecl; external LIB_AVCODEC;

(**
 * Pad image.
 *)
function av_picture_pad(var dst: PAVPicture; src: PAVPicture; height: integer; width: integer; pix_fmt: TAVPixelFormat;
 ...
 * found.
 *)
function avcodec_pix_fmt_to_codec_tag(pix_fmt: TAVPixelFormat): cardinal;
    cdecl; external LIB_AVCODEC;

(**
 * @deprecated see av_get_pix_fmt_loss()
 *)
function avcodec_get_pix_fmt_loss(var dst_pix_fmt: TAVPixelFormat; src_pix_fmt: TAVPixelFormat;
...
function avcodec_find_best_pix_fmt_of_list(pix_fmt_list: PAVPixelFormat;
                                            ...
                                            has_alpha: integer; loss_ptr: PInteger): TAVPixelFormat;
     cdecl; external LIB_AVCODEC;

(**
 * @deprecated see av_find_best_pix_fmt_of_2()
 *)
function avcodec_find_best_pix_fmt_of_2(st_pix_fmt1: TAVPixelFormat; dst_pix_fmt2: TAVPixelFormat;
...
function avcodec_default_get_format(s: PAVCodecContext; fmt: PAVPixelFormat): TAVPixelFormat;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_get_codec_tag_string(buf: PAnsiChar; buf_size: cardinal; codec_tag: cardinal): cardinal;
    cdecl; external LIB_AVCODEC;

procedure avcodec_string(buf: PAnsiChar; buf_size: integer; enc: PAVCodecContext; encode: integer);
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_get_profile_name(codec: PAVCodec; profile: integer): PAnsiChar;
    cdecl; external LIB_AVCODEC;

function avcodec_default_execute(c: PAVCodecContext; func: TExecuteFunc; arg: Pointer; ret: PInteger; count: integer; size: integer): integer;
    cdecl; external LIB_AVCODEC;

function avcodec_default_execute2(c: PAVCodecContext; func: TExecute2Func; arg: Pointer; ret: PInteger; count: integer): integer;
    cdecl; external LIB_AVCODEC;
//FIXME func typedef
...
function avcodec_fill_audio_frame(frame: PAVFrame; nb_channels: integer;
                             sample_fmt: TAVSampleFormat; buf: PByte;
                             buf_size: integer; align: integer): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_get_bits_per_sample(codec_id: TAVCodecID): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_get_pcm_codec(fmt: TAVSampleFormat; be : integer): TAVCodecID;
    cdecl; external LIB_AVCODEC;
 ...
 * @return Number of bits per sample or zero if unknown for the given codec.
 *)
function av_get_exact_bits_per_sample(codec_id: TAVCodecID): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *                     determine.
 *)
function av_get_audio_frame_duration(avctx: PAVCodecContext; frame_bytes: integer): integer;
    cdecl; external LIB_AVCODEC;
...
type
  ...
  TAVBitStreamFilter = record
    ...
    filter : function(bsfc: PAVBitStreamFilterContext;
                      avctx : PAVCodecContext; args: PAnsiChar;
                      var poutbuf: PByte; var poutbuf_size : integer;
 ...
 *)
procedure av_fast_padded_malloc(ptr : Pointer; size : PCardinal; min_size: cardinal);
    cdecl; external LIB_AVCODEC;
 ...
 *)
procedure av_fast_padded_mallocz(ptr : Pointer; size : PCardinal; min_size: cardinal);
    cdecl; external LIB_AVCODEC;
 ...
 *)
function av_xiphlacing(s: PAnsiChar; v: cardinal): cardinal;
    cdecl; external LIB_AVCODEC;
...
procedure av_log_missing_feature(avc: Pointer; feature: PAnsiChar; want_sample: integer);
    cdecl; external LIB_AVCODEC;
...
procedure av_log_ask_for_sample(avc: Pointer; msg: PAnsiChar);
    cdecl; external LIB_AVCODEC;
 ...
 *)
  ...
  TLockmgrFunc = function (mutex: Ppointer; op: TAVLockOp): integer;  cdecl;
 ...
 *)
function av_lockmgr_register(cb: TLockmgrFunc): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function avcodec_is_open(s: PAVCodecContext): integer;
    cdecl; external LIB_AVCODEC;

(**
 * @return a non-zero number if codec is an encoder, zero otherwise
 *)
function av_codec_is_encoder(codec: PAVCodec): integer;
    cdecl; external LIB_AVCODEC;

(**
 * @return a non-zero number if codec is a decoder, zero otherwise
 *)
function av_codec_is_decoder(codec : PAVCodec): integer;
    cdecl; external LIB_AVCODEC;
 ...
 *)
function avcodec_descriptor_next(prev: PAVCodecDescriptor): PAVCodecDescriptor;
    cdecl; external LIB_AVCODEC;
 ...
 *         exists.
 *)
function avcodec_descriptor_get_by_name(name: PAnsiChar): PAVCodecDescriptor;
    cdecl; external LIB_AVCODEC;
