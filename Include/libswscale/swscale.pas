 ...
 *)
function swscale_version(): cardinal;
 ...
 *)
function sws_getCoefficients(colorspace: integer): PInteger;
  cdecl; external LIB_SWSCALE;
 ...
 * otherwise.
 *)
function sws_isSupportedInput(pix_fmt: TAVPixelFormat): integer;
  cdecl; external LIB_SWSCALE;
 ...
 * otherwise.
 *)
function sws_isSupportedOutput(pix_fmt: TAVPixelFormat): integer;
  cdecl; external LIB_SWSCALE;
 ...
 *)
function sws_isSupportedEndiannessConversion(pix_fmt: TAVPixelFormat): integer;
  cdecl; external LIB_SWSCALE;
 ...
 * error
 *)
function sws_init_context(sws_context: PSwsContext; srcFilter: PSwsFilter; dstFilter: PSwsFilter): integer;
  cdecl; external LIB_SWSCALE;
 ...
 *       written
 *)
function sws_getContext(srcW: integer; srcH: integer; srcFormat: TAVPixelFormat;
                        dstW: integer; dstH: integer; dstFormat: TAVPixelFormat;
                        flags: integer; srcFilter: PSwsFilter;
                        dstFilter: PSwsFilter; param: PDouble): PSwsContext;
  cdecl; external LIB_SWSCALE;
 ...
 *)
function sws_scale(c: PSwsContext; const srcSlice: PPByteArray;
              const srcStride: PIntegerArray; srcSliceY: integer; srcSliceH: integer;
              const dst: PPByteArray; const dstStride: PIntegerArray): integer;
  cdecl; external LIB_SWSCALE;
 ...
 *)
function sws_setColorspaceDetails(c: PSwsContext; inv_table: PQuadIntegerArray;
              srcRange: integer; table: PQuadIntegerArray; dstRange: integer;
 ...
 * @return -1 if not supported
 *)
function sws_getColorspaceDetails(c: PSwsContext; var inv_table: PQuadIntegerArray;
              var srcRange: integer; var table: PQuadIntegerArray; var dstRange: integer;
 ...
 *)
function sws_allocVec(length: integer): PSwsVector;
  cdecl; external LIB_SWSCALE;
...
procedure sws_printVec2(a:         PSwsVector;
                        log_ctx:   PAVClass; // PAVClass is declared in log.pas
                        log_level: integer);
  cdecl; external LIB_SWSCALE;
...
function sws_getDefaultFilter(lumaGBlur: single; chromaGBlur: single;
                              lumaSharpen: single; chromaSharpen: single;
                              chromaHShift: single; chromaVShift: single;
                              verbose: integer): PSwsFilter;
  cdecl; external LIB_SWSCALE;
 ...
 *)
procedure sws_convertPalette8ToPacked32(const src: PByte; dst: PByte; num_pixels: integer;
                                        const palette: PByte);
  cdecl; external LIB_SWSCALE;
 ...
 * @param palette    array with [256] entries, which must match color arrangement (RGB or BGR) of src
 *)
procedure sws_convertPalette8ToPacked24(const src: PByte; dst: PByte; num_pixels: integer;
                                        const palette: PByte);
  cdecl; external LIB_SWSCALE;
 ...
 * @see av_opt_find().
 *)
function sws_get_class(): PAVClass;
  cdecl; external LIB_SWSCALE;
(**
 * @}
 *)
