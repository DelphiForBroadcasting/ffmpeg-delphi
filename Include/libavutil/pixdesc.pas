 ...
 *)
function av_color_range_name(range: TAVColorRange): PAnsiChar;
  cdecl; external LIB_AVUTIL;

(**
 * @return the name for provided color primaries or NULL if unknown.
 *)
function av_color_primaries_name(primaries: TAVColorPrimaries): PAnsiChar;
  cdecl; external LIB_AVUTIL;

(**
 * @return the name for provided color transfer or NULL if unknown.
 *)
function av_color_transfer_name(transfer: TAVColorTransferCharacteristic): PAnsiChar;
  cdecl; external LIB_AVUTIL;

(**
 * @return the name for provided color space or NULL if unknown.
 *)
function av_color_space_name(space: TAVColorSpace): PAnsiChar;
  cdecl; external LIB_AVUTIL;

(**
 * @return the name for provided chroma location or NULL if unknown.
 *)
function av_chroma_location_name(location: TAVChromaLocation): PAnsiChar;
  cdecl; external LIB_AVUTIL;
