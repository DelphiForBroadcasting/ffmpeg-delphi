 ...
 *)
procedure av_force_cpu_flags(flags: integer);
 ...
 *)
procedure av_set_cpu_flags_mask(mask: integer);
 ...
 *)
function av_parse_cpu_flags(s: PAnsiChar): integer;
  cdecl; external LIB_AVUTIL; deprecated;
 ...
 *)
function av_parse_cpu_caps(flags: PCardinal; s: PAnsiChar): integer;
  cdecl; external LIB_AVUTIL;

(**
 * @return the number of logical CPU cores present.
 *)
function av_cpu_count(): integer;
  cdecl; external LIB_AVUTIL;
