 ...
 *)
  ...
  TAVClass = record
     ...
     *)
    query_ranges: function (AVOR: PPAVOptionRanges; obj: pointer; key: PAnsiChar; flags: integer): integer; cdecl;
end;
 ...
 * recommended.
 *)
function AV_LOG_C(x : integer): integer; // Note: see avutil.pas
...
procedure av_log_set_flags(arg: integer);
  cdecl; external LIB_AVUTIL;
function av_log_get_flags(): integer;
  cdecl; external LIB_AVUTIL;
