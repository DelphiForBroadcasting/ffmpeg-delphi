 ...
 *)
function av_get_channel_layout(name: PAnsiChar): int64;
 ...
 *)
procedure av_get_channel_layout_string(buf: PAnsiChar; buf_size: integer; nb_channels: integer; channel_layout: int64);
  cdecl; external LIB_AVUTIL;
 ...
 *)
procedure av_bprint_channel_layout(bp: PAVBPrint; nb_channels: integer; channel_layout: int64);
  cdecl; external LIB_AVUTIL;

(**
 * Return the number of channels in the channel layout.
 *)
function av_get_channel_layout_nb_channels(channel_layout: int64): integer;
  cdecl; external LIB_AVUTIL;

(**
 * Return default channel layout for a given number of channels.
 *)
function av_get_default_channel_layout(nb_channels: integer): int64;
 ...
 *         on error.
 *)
function av_get_channel_layout_channel_index(channel_layout: int64;
 ...
 *)
function av_channel_layout_extract_channel(channel_layout: int64; index: integer): int64;
  cdecl; external LIB_AVUTIL;
 ...
 *)
function av_get_channel_name(channel: int64): PAnsiChar;
  cdecl; external LIB_AVUTIL;
 ...
 *)
function av_get_channel_description(channel: int64): PAnsiChar;
  cdecl; external LIB_AVUTIL;
 ...
 *)
function av_get_standard_channel_layout(index: cardinal; var layout: int64;
                                   var name: PAnsiChar): integer;
  cdecl; external LIB_AVUTIL;
