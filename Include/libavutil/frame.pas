...
{ Note: see in libavcodec/avcodec.pas line: 1530
const
...
{$IF FF_API_AVFRAME_LAVC}
     ...
     *)
    ref_index: array [0..1] of PShortint; {deprecated}
{$ENDIF}
...
{$IF FF_API_AVFRAME_LAVC}
    buffer_hints: integer; {deprecated}
    (**
     * Pan scan.
     *)
...
function  av_frame_get_pkt_duration(frame: PAVFrame): int64;
  cdecl; external LIB_AVUTIL;
procedure av_frame_set_pkt_duration(frame: PAVFrame; val: int64);
  cdecl; external LIB_AVUTIL;
function  av_frame_get_pkt_pos(frame: PAVFrame): int64;
  cdecl; external LIB_AVUTIL;
procedure av_frame_set_pkt_pos(frame: PAVFrame; val: int64);
  cdecl; external LIB_AVUTIL;
function  av_frame_get_channel_layout(frame:  PAVFrame): int64;
  cdecl; external LIB_AVUTIL;
procedure av_frame_set_channel_layout(frame: PAVFrame; val: int64);
  cdecl; external LIB_AVUTIL;
function  av_frame_get_channels(frame: PAVFrame): integer;
  cdecl; external LIB_AVUTIL;
procedure av_frame_set_channels(frame: PAVFrame; val: integer);
  cdecl; external LIB_AVUTIL;
function  av_frame_get_sample_rate(frame: PAVFrame): integer;
  cdecl; external LIB_AVUTIL;
procedure av_frame_set_sample_rate(frame: PAVFrame; val: integer);
  cdecl; external LIB_AVUTIL;
...
procedure av_frame_set_metadata(frame: PAVFrame; val: PAVDictionary);
  cdecl; external LIB_AVUTIL;
function  av_frame_get_decode_error_flags(frame: PAVFrame): integer;
  cdecl; external LIB_AVUTIL;
procedure av_frame_set_decode_error_flags(frame: PAVFrame; val: integer);
  cdecl; external LIB_AVUTIL;
function  av_frame_get_pkt_size(frame: PAVFrame): integer;
  cdecl; external LIB_AVUTIL;
procedure av_frame_set_pkt_size(frame: PAVFrame; val: integer);
  cdecl; external LIB_AVUTIL;
function avpriv_frame_get_metadatap(frame: PAVFrame): PPAVDictionary;
  cdecl; external LIB_AVUTIL;
function av_frame_get_qp_table(f: PAVFrame; stride: PInteger; type_: PInteger): PByte;
  cdecl; external LIB_AVUTIL;
 ...
 *)
function av_frame_is_writable(frame: PAVFrame): integer;
  cdecl; external LIB_AVUTIL;
 ...
 *)
function av_frame_make_writable(frame: PAVFrame): integer;
  cdecl; external LIB_AVUTIL;
 ...
 * frame is not valid.
 *)
function av_frame_get_plane_buffer(frame: PAVFrame; plane: integer): PAVBufferRef;
  cdecl; external LIB_AVUTIL;
