 ...
 * It is possible to configure muxers and demuxers using the @ref avoptions
 ...
 *)
function av_get_packet(s: PAVIOContext; pkt: PAVPacket; size: integer): integer;
 ...
 *)
function av_append_packet(s: PAVIOContext; pkt: PAVPacket; size: integer): integer;
  cdecl; external LIB_AVFORMAT;
...
type
  ...
  TAVOutputFormat = record
     ...
     *)
    interleave_packet: function (s: PAVFormatContext; var out_: PAVPacket; in_: PAVPacket; flush: integer): integer; cdecl;
    (**
    ...
    get_output_timestamp: procedure (s: PAVFormatContext; stream: integer; dts: PInt64; wall: PInt64); cdecl;
 ...
 *)
  TAVInputFormat = record
     ...
     *)
    read_header: function (c: PAVFormatContext): integer; cdecl;
     ...
     *)
    read_seek2: function (s:PAVFormatContext; stream_index: integer; min_ts: int64; ts: int64; max_ts: int64; flags: integer): integer; cdecl;
 ...
 *)
  ...
  TAVStreamParseType = (
    ...
    AVSTREAM_PARSE_FULL_RAW = (0 or (ord('R') shl 8) or (ord('A') shl 16) or (ord('W') shl 24)) //MKTAG(0,'R','A','W')
  ...
  TAVIndexEntry = record
    ...
    timestamp: int64;         (**<
                               ...
                               * is known
                               *)
    flags_size: integer; // 0..1: flags, 2..31: size
  ...
  *)
  ...
  PDurationErr = ^TDurationErr;
  TDurationErr = array[0..1] of array[0..MAX_STD_TIMEBASES - 1] of double;
   ...
   *)
  av_format_control_message = function(s: PAVFormatContext; type_: integer;
										 data: Pointer; data_size: cardinal): integer; cdecl;

  TAVOpenCallback = function(s: PAVFormatContext; var pb: PAVIOContext; const url: PAnsiChar; flags: integer;
...
{$ENDIF}
     ...
     * Demuxing: Set by user.
     *)
     open_cb : function(s : PAVFormatContext; var p: PAVIOContext; const url: PAnsiChar; flags: integer; int_cb: PAVIOInterruptCB; var options: PAVDictionary): integer; cdecl;
  end;
...
function av_stream_get_parser(s: PAVStream): PAVCodecParserContext;
  cdecl; external LIB_AVFORMAT;
function av_stream_get_recommended_encoder_configuration(s: PAVStream): PAnsiChar;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_stream_get_end_pts(st : PAVStream): int64;
  cdecl; external LIB_AVFORMAT;



function av_format_get_probe_score(s: PAVFormatContext): integer;
  cdecl; external LIB_AVFORMAT;
function av_format_get_video_codec(s: PAVFormatContext): PAVCodec;
  cdecl; external LIB_AVFORMAT;
procedure av_format_set_video_codec(s: PAVFormatContext; c: PAVCodec);
  cdecl; external LIB_AVFORMAT;
function av_format_get_audio_codec(s: PAVFormatContext): PAVCodec;
  cdecl; external LIB_AVFORMAT;
procedure av_format_set_audio_codec(s: PAVFormatContext; c: PAVCodec);
  cdecl; external LIB_AVFORMAT;
function av_format_get_subtitle_codec(s: PAVFormatContext): PAVCodec;
  cdecl; external LIB_AVFORMAT;
procedure av_format_set_subtitle_codec(s: PAVFormatContext; c: PAVCodec);
  cdecl; external LIB_AVFORMAT;
function av_format_get_data_codec(s : PAVFormatContext) : PAVCodec;
  cdecl; external LIB_AVFORMAT;
procedure av_format_set_data_codec(s: PAVFormatContext; c : PAVCodec);
  cdecl; external LIB_AVFORMAT;
function av_format_get_metadata_header_padding(s: PAVFormatContext): integer;
  cdecl; external LIB_AVFORMAT;
procedure av_format_set_metadata_header_padding(s: PAVFormatContext; c: integer);
  cdecl; external LIB_AVFORMAT;
function av_format_get_opaque(s: PAVFormatContext): Pointer;
  cdecl; external LIB_AVFORMAT;
procedure av_format_set_opaque(s: PAVFormatContext; opaque: Pointer);
  cdecl; external LIB_AVFORMAT;
function av_format_get_control_message_cb(s: PAVFormatContext): av_format_control_message;
  cdecl; external LIB_AVFORMAT;
procedure av_format_set_control_message_cb(s: PAVFormatContext; callback : av_format_control_message);
  cdecl; external LIB_AVFORMAT;
function av_format_get_open_cb(s: PAVFormatContext): TAVOpenCallback;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_fmt_ctx_get_duration_estimation_method(ctx: PAVFormatContext): TAVDurationEstimationMethod;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function avformat_network_init(): integer;
  cdecl; external LIB_AVFORMAT;

(**
 * Undo the initialization done by avformat_network_init.
 *)
function avformat_network_deinit(): integer;
  cdecl; external LIB_AVFORMAT;
...
function av_stream_get_side_data(stream: PAVStream;
								  type_: TAVPacketSideDataType; var size: integer): PByte;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_probe_input_format2(pd: PAVProbeData; is_opened: integer; score_max: PInteger): PAVInputFormat;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_probe_input_format3(pd: PAVProbeData; is_opened: integer; score_max: PInteger): PAVInputFormat;
  cdecl; external LIB_AVFORMAT;
...
function av_probe_input_buffer2(pb: PAVIOContext; fmt: PPAVInputFormat;
                          url: PAnsiChar; logctx: Pointer;
                          offset: cardinal; max_probe_size: cardinal): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function avformat_open_input(var ps: PAVFormatContext; url: PAnsiChar; fmt: PAVInputFormat; options: PPAVDictionary): integer;
 ...
 *)
function av_find_program_from_stream(ic: PAVFormatContext; last: PAVProgram; s: integer): PAVProgram;
  cdecl; external LIB_AVFORMAT;
 ...
 * @return >=0 on success, error code otherwise
 *)
function avformat_flush(s: PAVFormatContext): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function avformat_write_header(s: PAVFormatContext; options: PPAVDictionary): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 *          <0 if not
 *)
function av_write_uncoded_frame_query(s: PAVFormatContext; stream_index: integer): integer;
  cdecl; external LIB_AVFORMAT;
...
function av_get_output_timestamp(s: PAVFormatContext; stream: integer;
                            var dts: int64; var wall: int64): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
procedure av_hex_dump(f: Pointer; buf: PByte; size: integer);
  cdecl; external LIB_AVFORMAT;
 ...
 *)
procedure av_hex_dump_log(avcl: Pointer; level: integer; buf: PByte; size: integer);
  cdecl; external LIB_AVFORMAT;
 ...
 *)
procedure av_pkt_dump2(f: Pointer; pkt: PAVPacket; dump_payload: integer; st: PAVStream);
  cdecl; external LIB_AVFORMAT;
 ...
 * @param st AVStream that the packet belongs to
 *)
procedure av_pkt_dump_log2(avcl: Pointer; level: integer; pkt: PAVPacket; dump_payload: integer;
                          st: PAVStream);
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_codec_get_id(tags: PPAVCodecTag; tag: cardinal): TAVCodecID;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_codec_get_tag(tags: PPAVCodecTag; id: TAVCodecID): cardinal;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_codec_get_tag2(tags: PPAVCodecTag; id: TAVCodecID;
                      var tag: cardinal): integer;
  cdecl; external LIB_AVFORMAT;
...
function av_add_index_entry(st: PAVStream; pos: int64; timestamp: int64;
                       size: integer; distance: integer; flags: integer): integer;
  cdecl; external LIB_AVFORMAT;
...
procedure av_url_split(proto: PAnsiChar; proto_size: integer;
                  ...
                  ostname: PAnsiChar; hostname_size: integer;
				          port_ptr: PInteger;
...
function av_get_frame_filename(buf: PAnsiChar; buf_size: integer;
                          path: PAnsiChar; number: integer): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_filename_number_test(filename: PAnsiChar): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 * @return 0 if OK, AVERROR_xxx on error
 *)
function av_sdp_create(ac: array of PAVFormatContext; n_files: integer; buf: PAnsiChar; size: integer): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function av_match_ext(filename: PAnsiChar; extensions: PAnsiChar): integer;
  cdecl; external LIB_AVFORMAT;
 ...
 *)
function avformat_query_codec(ofmt: PAVOutputFormat;  codec_id: TAVCodecID;
                         std_compliance: integer): integer;
  cdecl; external LIB_AVFORMAT;
...
function avformat_match_stream_specifier(s: PAVFormatContext; st: PAVStream;
                                    spec: PAnsiChar): integer;
  cdecl; external LIB_AVFORMAT;

function avformat_queue_attached_pictures(s: PAVFormatContext): integer;
  cdecl; external LIB_AVFORMAT;
...
function avio_tell(s: PAVIOContext): int64; inline;
begin
