...
const
	...
	LLIBAVFILTER_VERSION_MINOR   = 0;
	LIBAVFILTER_VERSION_MICRO   = 10;
...
{$endif}
{$ifndef FF_API_FILL_FRAM}
  FF_API_FILL_FRAME                   = (LIBAVFILTER_VERSION_MAJOR < 5);
{$endif}
{$ifndef FF_API_BUFFERSRC_BUFFER}
  FF_API_BUFFERSRC_BUFFER             = (LIBAVFILTER_VERSION_MAJOR < 5);
{$endif}
...
{$ifndef FF_API_ACONVERT_FILTER}
  FF_API_ACONVERT_FILTER              = (LIBAVFILTER_VERSION_MAJOR < 5);
{$endif}
...
{$ifndef FF_API_DRAWTEXT_OLD_TIMELINE}
  FF_API_DRAWTEXT_OLD_TIMELINE        = (LIBAVFILTER_VERSION_MAJOR < 5);
{$endif}
