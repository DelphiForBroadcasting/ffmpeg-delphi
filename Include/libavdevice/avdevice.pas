...
function avdevice_list_input_sources(device: PAVInputFormat; const device_name: PAnsiChar;
                                device_options: PAVDictionary; var device_list: PAVDeviceInfoList): integer;
	cdecl; external LIB_AVDEVICE;
function avdevice_list_output_sinks(device: PAVInputFormat; const device_name: PAnsiChar;
                               device_options: PAVDictionary; var device_list: PAVDeviceInfoList): integer;
	cdecl; external LIB_AVDEVICE;
