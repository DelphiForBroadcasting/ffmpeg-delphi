 ...
 *)
function swr_init(s: PSwrContext): integer;
  cdecl; external LIB_SWRESAMPLE;
 ...
 *)
function swr_is_initialized(s: PSwrContext): integer;
  cdecl; external LIB_SWRESAMPLE;
 ...
 *)
function swr_next_pts(s: PSwrContext; pts: int64): int64;
  cdecl; external LIB_SWRESAMPLE;
 ...
 *)
function swr_set_compensation(s: PSwrContext; sample_delta: integer; compensation_distance: integer): integer;
  cdecl; external LIB_SWRESAMPLE;
 ...
 *)
function swr_set_channel_mapping(s: PSwrContext; channel_map: pinteger): integer;
  cdecl; external LIB_SWRESAMPLE;
 ...
 * @return  >= 0 on success, or AVERROR error code in case of failure.
 *)
function swr_set_matrix(s: PSwrContext; matrix: pdouble; stride: integer): integer;
  cdecl; external LIB_SWRESAMPLE;
 ...
 *)
function swr_drop_output(s: PSwrContext; count: integer): integer;
  cdecl; external LIB_SWRESAMPLE;
 ...
 * @return >= 0 on success, or a negative AVERROR code on failure
 *)
function swr_inject_silence(s: PSwrContext; count: integer): integer;
  cdecl; external LIB_SWRESAMPLE;
 ...
 *)
function swresample_version(): cardinal;
  cdecl; external LIB_SWRESAMPLE;
